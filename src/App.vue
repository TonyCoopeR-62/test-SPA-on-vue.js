...
<div>
  ...
  <hr>
  <appProgress v-bind:val="sum" v-bind:max="maxNumbers * 5"></appProgress>
  ...
  <appProgress v-bind:val="numbers.length" v-bind:max="maxNumbers"></appProgress>
  ...
  <hr>
  <ul class="list-group">
    <li class="list-group-item" v-for="number in numbers" v-bind:key="number"> {{ number }} </li>
  </ul>
</div>
</template>
<script>
